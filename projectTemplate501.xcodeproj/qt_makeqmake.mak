...
$(PROJECT_NAME).xcodeproj/project.pbxproj: projectTemplate.pro $(QT_CLANG64_PATH)/mkspecs/macx-clang/qmake.conf $(QT_CLANG64_PATH)/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o $(PROJECT_NAME).xcodeproj/project.pbxproj projectTemplate.pro -spec macx-xcode
